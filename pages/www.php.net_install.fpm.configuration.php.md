...
It seems there is no way to get informed about the access log format codes that are used or can be used. All I found is the source code.<br><br>It would really help, not to have open questions when deploying ?>
```
